...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    //	Register class and create window
    {
        ...
        wcex.lpszClassName = L"SampleGame_01WindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"SampleGame_01WindowClass", g_szAppName, WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX | WS_MAXIMIZEBOX,
