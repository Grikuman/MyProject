...
// アプリケーション名を定義する
LPCWSTR g_szAppName = L"Direct3D Game";
// プロトタイプを宣言する
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    // クラスを登録しウィンドウを生成する
    {
        ...
        wcex.lpszClassName = L"Direct3D_GameWindowClass";
        ...
        AdjustWindowRect(&rc, WS_OVERLAPPEDWINDOW, FALSE);
		  // ウィンドウを生成する
        HWND hwnd = CreateWindowExW(0, L"Direct3D_GameWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
