#pragma once
#ifndef TURRET_FORT_DEFINED
#define TURRET_FORT_DEFINED
#include "Interface/IComposite.h"

// 「砲台」クラスを定義する
class TurretFort : public IComposite
{
public:
	// ノード番号を取得する
...
public:
	// コンストラクタ
	TurretFort(IComponent* parent, const DirectX::SimpleMath::Vector3& position, const float& angle);
	// デストラクタ
	~TurretFort();
	// 初期化する
	void Initialize();
...
private:
	...
	// 砲台回転角
	DirectX::SimpleMath::Quaternion m_rotationFortAngle;
	// 質量
	float m_mass;
	// 砲塔部品配列
