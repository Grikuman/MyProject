...
void Game::CreateDeviceDependentResources()
{
    ...
    // DirectXを初期化する
    Graphics::GetInstance()->GetDeviceResources()->SetWindow(m_hWnd, width, height);
...
void Game::CreateWindowSizeDependentResources()
{
    ...
    if (m_scene)
    {
        ...
        m_scene->SetWindow(m_size.right, m_size.bottom);
    }
}
