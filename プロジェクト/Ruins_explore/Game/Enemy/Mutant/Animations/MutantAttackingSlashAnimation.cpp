...
*/
#include "pch.h"
#include "MutantAttackingSlashAnimation.h"
...
//---------------------------------------------------------
bool MutantAttackingSlashAnimation::GetEndAnimation()
{
	// アニメーションが終了した場合
...
// コンストラクタ
//---------------------------------------------------------
MutantAttackingSlashAnimation::MutantAttackingSlashAnimation(Mutant* mutant)
	:
	m_mutant{mutant},
	m_model{},
	m_time{},
...
// デストラクタ
//---------------------------------------------------------
MutantAttackingSlashAnimation::~MutantAttackingSlashAnimation()
{
...
// 初期化する
//---------------------------------------------------------
void MutantAttackingSlashAnimation::Initialize()
{
	// プレイヤーのモデルを取得する
	...
	// アニメーションをロードする
	m_animation->Load(L"Resources/SDKMesh/Mutant_Slash.sdkmesh_anim");
	// アニメーションとモデルをバインドする
...
// 更新する
//---------------------------------------------------------
void MutantAttackingSlashAnimation::Update(float elapsedTime)
{
	m_time += elapsedTime;
	// アニメーションが終了するまで更新
...
// 描画する
//---------------------------------------------------------
void MutantAttackingSlashAnimation::Render()
{
...
// 終了処理
//---------------------------------------------------------
void MutantAttackingSlashAnimation::Finalize()
{
...
// アニメーションモデルを描画する
//---------------------------------------------------------
void MutantAttackingSlashAnimation::DrawAnimation(
