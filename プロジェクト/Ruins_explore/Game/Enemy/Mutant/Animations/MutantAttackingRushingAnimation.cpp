...
*/
#include "pch.h"
#include "MutantAttackingRushingAnimation.h"
...
//---------------------------------------------------------
bool MutantAttackingRushingAnimation::GetEndAnimation()
{
	// アニメーションが終了した場合
...
// コンストラクタ
//---------------------------------------------------------
MutantAttackingRushingAnimation::MutantAttackingRushingAnimation(Mutant* mutant)
	:
	m_mutant{mutant},
	m_model{},
	m_time{},
...
// デストラクタ
//---------------------------------------------------------
MutantAttackingRushingAnimation::~MutantAttackingRushingAnimation()
{
...
// 初期化する
//---------------------------------------------------------
void MutantAttackingRushingAnimation::Initialize()
{
	// プレイヤーのモデルを取得する
...
// 更新する
//---------------------------------------------------------
void MutantAttackingRushingAnimation::Update(float elapsedTime)
{
	m_time += elapsedTime;
	// アニメーションが終了するまで更新
...
// 描画する
//---------------------------------------------------------
void MutantAttackingRushingAnimation::Render()
{
...
// 終了処理
//---------------------------------------------------------
void MutantAttackingRushingAnimation::Finalize()
{
...
// アニメーションモデルを描画する
//---------------------------------------------------------
void MutantAttackingRushingAnimation::DrawAnimation(
