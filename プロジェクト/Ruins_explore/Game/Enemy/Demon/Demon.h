...
*/
#pragma once
#include "Game/Enemy/Demon/States/DemonWalking.h"
#include "Game/Enemy/Demon/States/DemonPunching.h"
...
public:
    ...
    // 突進状態を取得する
    DemonPunching* GetDemonPunching() { return m_DemonPunching.get(); }
...
private:
    ...
    // 歩き状態
    std::unique_ptr<DemonWalking> m_DemonWalking;
    // 突進状態
    std::unique_ptr<DemonPunching> m_DemonPunching;
    // 位置
