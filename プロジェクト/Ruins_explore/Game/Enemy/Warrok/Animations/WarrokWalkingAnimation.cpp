/*
	ファイル名：WarrokWalkingAnimation.h
	　　　概要：ウォーロックの歩きアニメーションを管理するクラス
*/
#include "pch.h"
#include "WarrokWalkingAnimation.h"
...
void WarrokWalkingAnimation::Initialize()
{
	...
	// アニメーションをロードする
	m_animation->Load(L"Resources/SDKMesh/Warrok_Walking.sdkmesh_anim");
	// アニメーションとモデルをバインドする
...
// 更新する
//---------------------------------------------------------
void WarrokWalkingAnimation::Update()
{
	// 通常のアニメーション更新
...
// 描画する
//---------------------------------------------------------
void WarrokWalkingAnimation::Render()
{
...
// 終了処理
//---------------------------------------------------------
void WarrokWalkingAnimation::Finalize()
{
...
// アニメーションモデルを描画する
//---------------------------------------------------------
void WarrokWalkingAnimation::DrawAnimation(
