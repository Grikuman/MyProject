/*
	ファイル名：WarrokPunchingAnimation.h
	　　　概要：ウォーロックのパンチアニメーションを管理するクラス
*/
#include "pch.h"
#include "WarrokPunchingAnimation.h"
...
//---------------------------------------------------------
bool WarrokPunchingAnimation::IsEndAnimation()
{
	// アニメーションが終了した場合
...
// ダメージを与えることができるか取得する
//---------------------------------------------------------
bool WarrokPunchingAnimation::IsAbleToDealDamage()
{
...
// コンストラクタ
//---------------------------------------------------------
WarrokPunchingAnimation::WarrokPunchingAnimation(Warrok* warrok)
	:
	m_warrok{warrok},
	m_model{},
	m_time{},
...
// デストラクタ
//---------------------------------------------------------
WarrokPunchingAnimation::~WarrokPunchingAnimation()
{
...
// 初期化する
//---------------------------------------------------------
void WarrokPunchingAnimation::Initialize()
{
	// プレイヤーのモデルを取得する
	...
	// アニメーションをロードする
	m_animation->Load(L"Resources/SDKMesh/Warrok_Punching.sdkmesh_anim");
	// アニメーションとモデルをバインドする
...
// 更新する
//---------------------------------------------------------
void WarrokPunchingAnimation::Update()
{
...
// 描画する
//---------------------------------------------------------
void WarrokPunchingAnimation::Render()
{
...
// 終了処理
//---------------------------------------------------------
void WarrokPunchingAnimation::Finalize()
{
...
// アニメーションモデルを描画する
//---------------------------------------------------------
void WarrokPunchingAnimation::DrawAnimation(
