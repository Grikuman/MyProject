/*
	ファイル名：PlayerRollingAnimation.h
...
void PlayerRollingAnimation::Initialize()
{
	...
	// アニメーションをロードする
	m_animation->Load(L"Resources/SDKMesh/Player_Rolling.sdkmesh_anim");
	// アニメーションとモデルをバインドする
...
// 描画する
//---------------------------------------------------------
void PlayerRollingAnimation::Render()
{
...
// 終了処理
//---------------------------------------------------------
void PlayerRollingAnimation::Finalize()
{
